...
public final class WalletExtensionGrpc {
  ...
  public static final io.grpc.MethodDescriptor<shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated,
      shop.tronlucky.trondapp.api.GrpcAPI.TransactionList> METHOD_GET_TRANSACTIONS_FROM_THIS = getGetTransactionsFromThisMethod();

  private static volatile io.grpc.MethodDescriptor<shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated,
      shop.tronlucky.trondapp.api.GrpcAPI.TransactionList> getGetTransactionsFromThisMethod;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated,
      shop.tronlucky.trondapp.api.GrpcAPI.TransactionList> getGetTransactionsFromThisMethod() {
    io.grpc.MethodDescriptor<shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated, shop.tronlucky.trondapp.api.GrpcAPI.TransactionList> getGetTransactionsFromThisMethod;
      ...
      synchronized (WalletExtensionGrpc.class) {
        if ((getGetTransactionsFromThisMethod = WalletExtensionGrpc.getGetTransactionsFromThisMethod) == null) {
          WalletExtensionGrpc.getGetTransactionsFromThisMethod = getGetTransactionsFromThisMethod = 
              io.grpc.MethodDescriptor.<shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated, shop.tronlucky.trondapp.api.GrpcAPI.TransactionList>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "protocol.WalletExtension", "GetTransactionsFromThis"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  shop.tronlucky.trondapp.api.GrpcAPI.TransactionList.getDefaultInstance()))
  ...
  public static final io.grpc.MethodDescriptor<shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated,
      shop.tronlucky.trondapp.api.GrpcAPI.TransactionListExtention> METHOD_GET_TRANSACTIONS_FROM_THIS2 = getGetTransactionsFromThis2Method();

  private static volatile io.grpc.MethodDescriptor<shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated,
      shop.tronlucky.trondapp.api.GrpcAPI.TransactionListExtention> getGetTransactionsFromThis2Method;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated,
      shop.tronlucky.trondapp.api.GrpcAPI.TransactionListExtention> getGetTransactionsFromThis2Method() {
    io.grpc.MethodDescriptor<shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated, shop.tronlucky.trondapp.api.GrpcAPI.TransactionListExtention> getGetTransactionsFromThis2Method;
      ...
      synchronized (WalletExtensionGrpc.class) {
        if ((getGetTransactionsFromThis2Method = WalletExtensionGrpc.getGetTransactionsFromThis2Method) == null) {
          WalletExtensionGrpc.getGetTransactionsFromThis2Method = getGetTransactionsFromThis2Method = 
              io.grpc.MethodDescriptor.<shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated, shop.tronlucky.trondapp.api.GrpcAPI.TransactionListExtention>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
              ...
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  shop.tronlucky.trondapp.api.GrpcAPI.TransactionListExtention.getDefaultInstance()))
  ...
  public static final io.grpc.MethodDescriptor<shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated,
      shop.tronlucky.trondapp.api.GrpcAPI.TransactionList> METHOD_GET_TRANSACTIONS_TO_THIS = getGetTransactionsToThisMethod();

  private static volatile io.grpc.MethodDescriptor<shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated,
      shop.tronlucky.trondapp.api.GrpcAPI.TransactionList> getGetTransactionsToThisMethod;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated,
      shop.tronlucky.trondapp.api.GrpcAPI.TransactionList> getGetTransactionsToThisMethod() {
    io.grpc.MethodDescriptor<shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated, shop.tronlucky.trondapp.api.GrpcAPI.TransactionList> getGetTransactionsToThisMethod;
  ...
  public static final io.grpc.MethodDescriptor<shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated,
      shop.tronlucky.trondapp.api.GrpcAPI.TransactionListExtention> METHOD_GET_TRANSACTIONS_TO_THIS2 = getGetTransactionsToThis2Method();

  private static volatile io.grpc.MethodDescriptor<shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated,
      shop.tronlucky.trondapp.api.GrpcAPI.TransactionListExtention> getGetTransactionsToThis2Method;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated,
      shop.tronlucky.trondapp.api.GrpcAPI.TransactionListExtention> getGetTransactionsToThis2Method() {
    io.grpc.MethodDescriptor<shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated, shop.tronlucky.trondapp.api.GrpcAPI.TransactionListExtention> getGetTransactionsToThis2Method;
  ...
  public static abstract class WalletExtensionImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getTransactionsFromThis(shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated request,
        io.grpc.stub.StreamObserver<shop.tronlucky.trondapp.api.GrpcAPI.TransactionList> responseObserver) {
     ...
     * </pre>
     */
    public void getTransactionsFromThis2(shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated request,
        io.grpc.stub.StreamObserver<shop.tronlucky.trondapp.api.GrpcAPI.TransactionListExtention> responseObserver) {
     ...
     * </pre>
     */
    public void getTransactionsToThis(shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated request,
        io.grpc.stub.StreamObserver<shop.tronlucky.trondapp.api.GrpcAPI.TransactionList> responseObserver) {
     ...
     * </pre>
     */
    public void getTransactionsToThis2(shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated request,
        io.grpc.stub.StreamObserver<shop.tronlucky.trondapp.api.GrpcAPI.TransactionListExtention> responseObserver) {
    ...
    @Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated,
                shop.tronlucky.trondapp.api.GrpcAPI.TransactionList>(
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated,
                shop.tronlucky.trondapp.api.GrpcAPI.TransactionListExtention>(
  ...
  public static final class WalletExtensionBlockingStub extends io.grpc.stub.AbstractStub<WalletExtensionBlockingStub> {
     ...
     * </pre>
     */
    public shop.tronlucky.trondapp.api.GrpcAPI.TransactionList getTransactionsFromThis(shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated request) {
     ...
     * </pre>
     */
    public shop.tronlucky.trondapp.api.GrpcAPI.TransactionListExtention getTransactionsFromThis2(shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated request) {
      return blockingUnaryCall(
     ...
     * </pre>
     */
    public shop.tronlucky.trondapp.api.GrpcAPI.TransactionList getTransactionsToThis(shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated request) {
      return blockingUnaryCall(
     ...
     * </pre>
     */
    public shop.tronlucky.trondapp.api.GrpcAPI.TransactionListExtention getTransactionsToThis2(shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated request) {
      return blockingUnaryCall(
  ...
  public static final class WalletExtensionFutureStub extends io.grpc.stub.AbstractStub<WalletExtensionFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<shop.tronlucky.trondapp.api.GrpcAPI.TransactionList> getTransactionsFromThis(
        shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<shop.tronlucky.trondapp.api.GrpcAPI.TransactionListExtention> getTransactionsFromThis2(
        shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated request) {
      return futureUnaryCall(
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<shop.tronlucky.trondapp.api.GrpcAPI.TransactionList> getTransactionsToThis(
        shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated request) {
      return futureUnaryCall(
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<shop.tronlucky.trondapp.api.GrpcAPI.TransactionListExtention> getTransactionsToThis2(
        shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_TRANSACTIONS_FROM_THIS:
          serviceImpl.getTransactionsFromThis((shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated) request,
              (io.grpc.stub.StreamObserver<shop.tronlucky.trondapp.api.GrpcAPI.TransactionList>) responseObserver);
          break;
        case METHODID_GET_TRANSACTIONS_FROM_THIS2:
          serviceImpl.getTransactionsFromThis2((shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated) request,
              (io.grpc.stub.StreamObserver<shop.tronlucky.trondapp.api.GrpcAPI.TransactionListExtention>) responseObserver);
          break;
        case METHODID_GET_TRANSACTIONS_TO_THIS:
          serviceImpl.getTransactionsToThis((shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated) request,
              (io.grpc.stub.StreamObserver<shop.tronlucky.trondapp.api.GrpcAPI.TransactionList>) responseObserver);
          break;
        case METHODID_GET_TRANSACTIONS_TO_THIS2:
          serviceImpl.getTransactionsToThis2((shop.tronlucky.trondapp.api.GrpcAPI.AccountPaginated) request,
              (io.grpc.stub.StreamObserver<shop.tronlucky.trondapp.api.GrpcAPI.TransactionListExtention>) responseObserver);
          break;
        default:
